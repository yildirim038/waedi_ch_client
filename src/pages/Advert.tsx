...
const Advert: React.FC = () => {
  ...
  return (
    <div>
        ...
        <div className="container-fluid">
          ...
          {role && (
            <div className="row">
              ...
              <div className="directory-text col-8 col-md-9">
                <div className="row">
          ...
          {!role && (
            <div className="directory-text">
              ...
              <div className="directory-plus-icon text-center">
                <button onClick={openModal} className="event-plus-icon"><img src={plusIcon} alt="add" /></button>
              </div>
            </div>
          )}
        </div>
      ...
      {isModalOpen && (<div className="modal-add-event-open"><AddAdvert closeModal={closeModal} setAdvertData={setAdvertData}/></div>)}
      {isModalUpdateOpen && (<UpdateAdvert clickId = {clickId} closeModal={closeUpdateModal} setAdvertData={setAdvertData} returnAllAdvert={returnAllAdvert}/>)}
    </div>
  );
}; 
