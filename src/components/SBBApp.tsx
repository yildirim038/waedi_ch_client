      ...
      <form onSubmit={callSBB} id="sbbapp">
        {
          <>
            ...
            <div className="sbb-form-container">
              <div className='sbb-form-label-container'>
              <input type="radio" value="false" name="isArrival" checked id="departure" />
              <label htmlFor="departure" className="sbb-form-label-abfahrt;">Abfahrt</label>
              <input type="radio" value="true" name="isArrival" id="arrival" className="is_arrival"/>
              <label htmlFor="arrival">Ankunft</label>
            </div>     
          </div>
        <div className="sbb-form-container">
          <div className='sbb-form-label-container'>
