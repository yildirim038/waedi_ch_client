          ...
          <div>
            <div className='sbb-form-container ms-2'>
              <div className='sbb-form-label-container'>
                ...
                <input id="from" type="text" name="from" placeholder="Ort" className="sbb-form-input" onChange={e => setFrom(e.target.value)}/>
              </div>
              <div className='sbb-form-label-container ms-2'>
                <label className="sbb-form-label">Nach:</label>
                <input id="to" type="text" name="to" className="sbb-form-input" onChange={e => setTo(e.target.value)}/>
              </div>      
            </div>
            <div className='sbb-form-container ms-2'>
                <div className='sbb-form-label-container'>
            ...
            <div className="sbb-form-container ">
              <div>
                <input type="radio" value="false" name="isArrival" id="departure" className='ms-2 ' />
            ...
            <div className="sbb-form-container ms-2">
              <div>
                <input type="submit" value="Verbindung suchen" id="search--sbb" className='sbb-search button'/>
              </div>      
            </div>
          </div>    
        }
