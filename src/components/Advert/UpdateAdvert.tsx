...
import { AdvertUpdateType, UpdateAdvertType } from "../../type/advertType";
      ...
      <div className="add-event-container">
        ...
        <div className="add-event-input-container">
          ...
          <div className="event-input-element">
            ...
            <select value={values.advertPage} onChange={(e) => setValue({ ...values, advertPage: e.target.value })}>
          ...
          <div className="event-input-element">
            ...
            <select value={values.advertType} onChange={(e) => setValue({ ...values, advertType: e.target.value })}>
          ...
          <div className="event-input-element">
            <label>Publish</label>
            <select value={values.publish ? "true" : "false"} onChange={(e) => setValue({ ...values, publish: e.target.value === "true" })}>
        ...
        <div className="form-button-container">
          <button className="form-button" onClick={handleUpdateAdvert}>Update Werbung</button>
